  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <img src="/fondo_pc.png" alt="" className="absolute inset-0 h-full w-full object-cover" style={{ opacity: 1 }} />
        <div className="absolute inset-0" style={{ background: 'rgba(2,4,8,0.25)' }} />
      </div>
      <AnimatePresence>
